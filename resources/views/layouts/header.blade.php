...
<head>
    ...
    <!-- Favicon Icon -->
    <link rel="icon" type="image/png" href="{{URL('assets/assets/images/fav.png')}}">
    ...
    <div class="top-header-group">
        <div class="top-header">
            <div class="res_main_logo">
                <a href="{{URL('/')}}"><img src="{{URL('assets/images/dark-logo-1.svg')}}" alt=""></a>
            </div>
        ...
        <div class="sub-header">
                ...
                <div class="container-fluid">
                    ...
                    <div
                        ...
                        <ul class="navbar-nav main_nav align-self-stretch">
                            ...
                            <li class="nav-item"><a href="shop_grid.html" class="nav-link" title="Featured Products">Featured
                                    Products</a></li>
                            <li class="nav-item">
                                <div class="ui icon top left dropdown nav__menu">
                                    ...
                                    <div class="menu dropdown_page">
                                        ...
                                        <a href="single_product_view.html" class="item channel_item page__links">Single
                                            Product View</a>
            ...
            <div class="header_cart order-1">
                <a href="#" class="cart__btn hover-btn pull-bs-canvas-left" title="Cart"><i
                        class="uil uil-shopping-cart-alt"></i><span>Cart</span>
                    <ins>2</ins>
